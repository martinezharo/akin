...
export const GITHUB_REPO_URL = "https://github.com/martinezharo/akin";

/**
 * A small pinned badge in the bottom-right corner of the landing page — the
 * only outbound link on the front door, so it stays out of the reading flow
 * instead of competing with the calls to action.
 */
export function GithubLink() {
	return (
		<a
			...
			aria-label={ui.landing.githubLabel}
			title={ui.landing.githubLabel}
		>
